package com.lojavirtual.lojavirtual.excecao;
...
@ControllerAdvice
public class LojaVirtualTratamentoExcecao extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleRegraNegocioException(RegraNegocioException ex, WebRequest request) {
